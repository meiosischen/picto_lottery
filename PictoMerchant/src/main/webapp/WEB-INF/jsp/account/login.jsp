...
<div class="login_form">
	<h1 class="login_head">店铺登录</h1>
	<form action="<%=request.getContextPath()%>/doLogin.do" method="post">
		<dl class="login_table">
			<dt>用户名</dt>
			<dd><input type="text" name="accountName" /></dd>
			<dt>密码</dt>
			<dd><input type="password" name="accountPwd" /></dd>
			<dt>验证码</dt>
			<dd><input type="text" name="validCode" style="width:60px;" maxlength="4" /> <img src="<%=request.getContextPath()%>/verifyImage.do" id="valid_code_img" valign="middle" onclick="refreshVericode(this.id)" /></dd>
		</dl>
		<div class="login_butt"><input type="submit" value="登录" /></div>
	</form>
</div>
