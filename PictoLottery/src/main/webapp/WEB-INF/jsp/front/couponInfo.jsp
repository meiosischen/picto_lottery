...
<div id="main">
	<div id="map" style="height:90%; width:94%; left:3%; top:5%; background-color:#000; position:absolute; display:none; z-index:9999; border:2px solid #fff;">
		...
		<div style="text-align:center; margin-top:10px;"><span style="font-size:27px;">${couponMerchant.treasureText1}</span><br/><span style="font-size:33px;">${couponMerchant.treasureText2}</span></div>
	</div>
    <div id="top">
        <div id="merchantInfo">
            <div id="location">
        ...
        <div id="couponLeft">
	        ...
	        <c:choose>
	            <c:when test="${couponTypeVal == 4}">
	                <span style="font-size:33px;">其他字符在哪？<span style="border-bottom:1px solid #fff;" class="showMap">点我显示</span></span>
	            </c:when>
	            <c:otherwise>
